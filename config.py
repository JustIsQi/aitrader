...
DATA_DIR_QUOTES = DATA_DIR.joinpath('akshare_data')
# DATA_STOCK_QUOTES = DATA_DIR.joinpath('stock_quotes')
# DATA_STOCK_VALUE_QUOTES = DATA_DIR.joinpath('stock_value_quotes')
# DATA_STOCK_IND_QUOTES = DATA_DIR.joinpath('stock_ind_quotes')
# DATA_BOND_QUOTES = DATA_DIR.joinpath('bond_quotes')
